...
[here](http://releases.k8s.io/release-1.1/docs/proposals/disk-accounting.md).
...
Volumes are slightly different from the other use cases local disk. They are pod scoped. Their lifetime is tied to that of a pod. Due to this property accounting of volumes will also be at the pod level.
